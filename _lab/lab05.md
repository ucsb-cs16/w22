...
* <https://github.com/ucsb-cs16-w22/STARTER-lab05>

To add a remote for this repo, we'll use the ssh url, like this:

```
git remote add starter git@github.com:ucsb-cs16-w22/STARTER-lab05.git
```
...
Check on the GitHub webpage for the course organization (<https://github.com/ucsb-cs16-w22>) to find your repo for this lab and make sure that
